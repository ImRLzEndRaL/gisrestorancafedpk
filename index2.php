...
<head>
  ...
  <title>SIG RESTORAN & CAFE KOTA DEPOK</title>
      ...
      <div class="header-container d-flex align-items-center">
        ...
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <li><a href="#portfolio">Lokasi Restoran & Cafe</a></li>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <h2>SIG RESTORAN & CAFE KOTA DEPOK</h2>
            <h3>Sistem informasi ini merupakan aplikasi pemetaan geografis restoran & cafe di Kota Depok.</h3>
          </div>
